...
const CallToAction = () => {
    return (
        <section className="py-20 bg-indigo-600 -mx-6 px-6 text-center">
            ...
            <Link href="/dashboard">
                <Button size="lg" className="h-14 px-8 bg-white text-indigo-600 hover:bg-gray-50 font-semibold text-lg">
                    Start Free Trial
