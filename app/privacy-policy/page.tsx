                    ...
                    <div className="prose max-w-none">
                        ...
                        <section className="mb-8">
                            ...
                            <p className="text-gray-700 mb-4">
                                ...
                                cookie settings through your browser, but disabling cookies may affect functionality.
                            </p>
                        </section>
                        ...
                        <section className="mb-8">
                            ...
                            <p className="text-gray-700 mb-4">
                                Our service may contain links to third-party websites or integrate with third-party services. This Privacy Policy
                                does not apply to these external services, and we encourage you to review their privacy policies.
                            </p>
                        </section>
                        ...
                        <section className="mb-8">
                            ...
                            <p className="text-gray-700 mb-4">
                                ...
                                are protected by appropriate safeguards in accordance with applicable data protection laws.
                            </p>
                        </section>
